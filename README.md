...
Then open `dist/superagent-0.1.23.mcaddon` with Minecraft Education and activate both the behavior pack and resource pack in the world. A world owner or teacher must activate the pack first. After that, Member + Survival players can use the MakeCode extension blocks.
...
```text
https://github.com/numraise/raisesuperagent#superagent-0.1.23
```
